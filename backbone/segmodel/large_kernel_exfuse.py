...
from models.segmodel.deeplab_resnet import ModelBuilder
...
class GCNFuse(nn.Module):
    ...
    def forward(self, x):
        ...
        y = self.deconv2(gcn1 + out1) #64
        y = self.deconv3(gcn2 + y)    #128
        y = self.deconv4(gcn3 + y)    #256
        y = self.deconv5(y)           #512
        y = self.DAP(y)
        return y
